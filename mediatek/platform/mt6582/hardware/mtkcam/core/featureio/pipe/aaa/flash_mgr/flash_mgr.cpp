...
#define logW(fmt, arg...) XLOGE("MWarning: func=%s line=%d: "fmt, __FUNCTION__, __LINE__, ##arg)
#endif
//====================================================
// functions prototype
...
{
	MINT32 i4Sutterdelay,i4SensorGainDelay,i4IspGainDelay,pfRunCycleFrames;
...
#define FLASH_STATUS_ON 2
	...
	if(m_pfFrameCount==0)
	{
		...
		LogInfo("pfRunCycleFrames %d %d %d %d",pfRunCycleFrames, i4SutterDelay, i4SensorGainDelay, i4IspGainDelay);
		if(pfRunCycleFrames<3)
		{
			pfRunCycleFrames = 3;
			logW("pfRunCycleFrames smaller than 3");
		}
