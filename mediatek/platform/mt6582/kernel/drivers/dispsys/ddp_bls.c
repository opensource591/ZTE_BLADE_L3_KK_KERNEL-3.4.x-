...
int disp_bls_set_backlight(unsigned int level)
{
    ...
    BLS_MSG("yzb_disp_bls_set_backlight: %d, gBLSPowerOn = %d\n", level, gBLSPowerOn);
#if 0
	if(519<level&&level<540)
	{
		level = 480;
	}
	else if(500<level&&level<520)
	{
		level = 300;
	}
	else if(400<level&&level<501)
	{
		level =280;
	}
	else if(320<level&&level<401)
	{
		level =270;
	}
	else if(290<level&&level<321)
	{
		level =260;
	}
	else if(270<level&&level<291)
	{
		level =250;
	}
	else if(250<level&&level<271)
	{
		level =240;
	}
	else if(234<level&&level<251)
	{
		level =235;
	}
#endif
