...
static void hw_bc11_dump_register(void)
{
 ...
 static kal_uint32 charging_set_current(void *data)
 {
	...
	printk("meepo---charging_set_current:%d\n",current_value);
	...
	//	printk("meepo---set_chr_current:%d\n",set_chr_current);
		register_value = charging_parameter_to_value(CS_VTH, array_size ,set_chr_current);
	//	printk("meepo---register_value:%d\n",register_value);
		bq24158_set_iocharge(register_value);
	}
	return status;
 } 	

 extern kal_uint8 g_reg_value_bq24158;
 ...
 static kal_uint32 charging_set_input_current(void *data)
 {
	...
	kal_uint32 array_size;
	kal_uint32 register_value;
	kal_uint32 tmp = *(kal_uint32 *)data;
//	printk("yzb------charging_set_input_current:%d\n",tmp);
	if(*(kal_uint32 *)data < CHARGE_CURRENT_600_00_MA)
		g_reg_value_bq24158 = 1;
...
//		printk("yzb---input_current---set_chr_current:%d\n",set_chr_current);
    	register_value = charging_parameter_to_value(INPUT_CS_VTH, array_size ,set_chr_current);
//		printk("yzb---input_current---register_value:%d\n",register_value);
    }
//    printk("yzb---input_current---register_value:%d\n",register_value);
 ...
 static kal_uint32 charging_get_charging_status(void *data)
 {
	...
	printk("charging_get_charging_status____for_full:%d\n",ret_val);
	if(ret_val == 0x2)
		*(kal_uint32 *)data = KAL_TRUE;
	else
		*(kal_uint32 *)data = KAL_FALSE;
//	printk("charging_get_charging_status:%d\n",status);
	return status;
 } 	
...
//	   printk("yzb__charging_get_battery_status:%d\n",status);
	   return status;
 }
