...
static struct platform_device actuator_dev_1 = {
	.name		  = "lens_actuator1",
	.id		  = -1,
};
static struct platform_device actuator_dev_2 = {
	.name		  = "lens_actuator2",
	.id		  = -1,
};
static struct platform_device actuator_dev_3 = {
	.name		  = "lens_actuator3",
	.id		  = -1,
};
static struct platform_device actuator_dev_4 = {
	.name		  = "lens_actuator4",
	.id		  = -1,
};
static struct platform_device actuator_dev_5 = {
	.name		  = "lens_actuator5",
	.id		  = -1,
};
...
#endif
#if 1  //defined(CONFIG_ACTUATOR)
    retval = platform_device_register(&actuator_dev_2);
    if (retval != 0){
        return retval;
    }
#endif
...
#if 1  //defined(CONFIG_ACTUATOR)
    retval = platform_device_register(&actuator_dev_3);
    if (retval != 0){
        return retval;
    }
#endif
...
#if 1  //defined(CONFIG_ACTUATOR)
    retval = platform_device_register(&actuator_dev_4);
    if (retval != 0){
        return retval;
    }
#endif
...
#if 1  //defined(CONFIG_ACTUATOR)
    retval = platform_device_register(&actuator_dev_5);
    if (retval != 0){
        return retval;
    }
#endif
