                ...
                //DDR1000
                    ...
                    //DDR912
                    	...
                    	//DDR667
								...
								#define pllc1_mempll_n_info_23_0_n4 	(0x00210e10 << 1)
							#else
								#define pllc1_mempll_n_info_30_24_n4	(0x00000050 << 25)
								#define pllc1_mempll_n_info_23_0_n4 	(0x000c30c3 << 1)
							#endif
                ...
                //DDR1000
                    ...
                    //DDR912
						...
						//DDR667
							...
							#define mempll3_m4pdiv_1_0		(0x00000000 << 10)
							#ifdef DDRPHY_3PLL_MODE
								#define mempll3_fbdiv_6_0	(0x00000007 << 2)
							#else
								#define mempll3_fbdiv_6_0	(0x0000002a << 2)
							#endif
						#else
                ...
                //DDR1000
                    ...
                    //DDR912
						...
						//DDR667
							...
							#define mempll4_m4pdiv_1_0		(0x00000000 << 10)
							#ifdef DDRPHY_3PLL_MODE
								#define mempll4_fbdiv_6_0	(0x00000007 << 2)
							#else
								#define mempll4_fbdiv_6_0	(0x0000002a << 2)
							#endif
						#else
...
int CLK_Monitor(enum ckmon_sel ckmon, enum monitor_clk_sel sel, int div)
{
    ...
    if(div > 255)
    {
    	print("CLK_Monitor error parameter\n");
    	return 1;
    }
    ...
    DRV_WriteReg32(CLK_CFG_10, temp);

    temp = DRV_Reg32(CLK_CFG_11);
    temp = temp & (~(0xff<<ckmon_shift));
    temp = temp | ((div&0xff)<<ckmon_shift);
    DRV_WriteReg32(CLK_CFG_11, temp);

    print("CLK_Monitor Reg: CLK_CFG_10=0x%x, CLK_CFG_11=0x%x\n", DRV_Reg32(CLK_CFG_10), DRV_Reg32(CLK_CFG_11));
